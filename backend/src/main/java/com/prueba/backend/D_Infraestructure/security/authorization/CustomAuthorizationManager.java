package com.prueba.backend.D_Infraestructure.security.authorization;
...
import com.prueba.backend.D_Infraestructure.repository.OperationRepository;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
     ...
     * it's going to get after current context path like /product/1
     * @param request
     * @return
     */
